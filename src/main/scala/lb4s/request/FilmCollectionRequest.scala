...
import lb4s.primitive.{FilmFilterType, FilmRelationshipType, IncludeType, LBID}
...
/**
  ...
  */
case class FilmCollectionRequest(
  sort: String = "FilmPopularity",
  genre: Option[String] = None,
  decade: Option[Int] = None,
  year: Option[Int] = None,
  service: Option[LBID] = None,
  where: Option[List[FilmFilterType.Value]] = None,
...
object FilmCollectionRequest {
  implicit val format: Format[FilmCollectionRequest] = Json.format[FilmCollectionRequest]
}
