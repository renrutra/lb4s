...
/**
  ...
  */
case class FilmContributionsRequest(
  cursor: Option[Cursor] = None,
  perPage: Int = 20,
  sort: String = "FilmPopularity",
  filmId: List[String] = Nil,
  `type`: Option[FilmContributionType.Value] = None,
...
object FilmContributionsRequest {
  implicit val format: Format[FilmContributionsRequest] = Json.format[FilmContributionsRequest]
}
